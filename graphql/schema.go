...
const schema string = `
    ...
    type Block {
        ...
        nonce: Bytes!
        # TransactionsRoot is the Blake256 hash of the root of the trie of transactions in this block.
        transactionsRoot: Bytes32!
        # TransactionCount is the number of transactions in this block. if
        # transactions are not available for this block, this field will be null.
        transactionCount: Long
        # StateRoot is the Blake256 hash of the state trie after this block was processed.
        stateRoot: Bytes32!
        # ReceiptsRoot is the Blake256 hash of the trie of transaction receipts in this block.
        ...
        # OmmerHash is the Blake256 hash of all the ommers (AKA uncles)
