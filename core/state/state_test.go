...
func TestDump(t *testing.T) {
	...
	obj2.SetCode(crypto.Blake256Hash([]byte{3, 3, 3, 3, 3, 3, 3}), []byte{3, 3, 3, 3, 3, 3, 3})
...
func TestSnapshot2(t *testing.T) {
	...
	so0.SetNonce(43)
	so0.SetCode(crypto.Blake256Hash([]byte{'c', 'a', 'f', 'e'}), []byte{'c', 'a', 'f', 'e'})
	so0.suicided = false
	so0.deleted = false
	...
	so1.SetNonce(53)
	so1.SetCode(crypto.Blake256Hash([]byte{'c', 'a', 'f', 'e', '2'}), []byte{'c', 'a', 'f', 'e', '2'})
	so1.suicided = true
	so1.deleted = true
